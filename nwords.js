...
// @version  20220202131337476175429
...
highlightWord('backen'); 
highlightWord('klär ut sig'); 
highlightWord('retad'); 
highlightWord('kikar'); 
highlightWord('Efter ett tag'); 
highlightWord('fartyg'); 
highlightWord('lastat'); 
highlightWord('förebyggande'); 
highlightWord('lasta'); 
highlightWord('rättare sagt'); 
highlightWord('rederiet'); 
highlightWord('strängare'); 
highlightWord('prosit'); 
highlightWord('hyllades'); 
highlightWord('brandkåren'); 
highlightWord('Värnpliktiga'); 
highlightWord('tyngdlyftning'); 
highlightWord('vibrerar'); 
highlightWord('folkrika'); 
highlightWord('föremål'); 
highlightWord('varit med om '); 
highlightWord('smällare'); 
highlightWord('slänga'); 
highlightWord('lindriga'); 
highlightWord('brevlådorna'); 
highlightWord('troligen'); 
highlightWord('vårdskuld'); 
highlightWord('bivax'); 
highlightWord('miljöboven'); 
highlightWord('ärr'); 
highlightWord('jordskredet'); 
