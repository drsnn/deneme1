...
highlightWord('ursprungligen'); highlightWord('antäll'); highlightWord('särskilda'); highlightWord('tingsrätten'); highlightWord('myndigheten'); highlightWord('källar'); highlightWord('översvämningar'); highlightWord('motståndare'); highlightWord('åklagare'); highlightWord('Världsnaturfonden'); highlightWord('smycken'); highlightWord('inneburit'); highlightWord('innebär'); highlightWord('anställd'); highlightWord('antäll');
