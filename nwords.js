...
// @version  20211205151209547292969
...
highlightWord('nog'); 
highlightWord('upprorsmakarna'); 
highlightWord('kravaller'); 
highlightWord('upploppen'); 
highlightWord('budskapet '); 
highlightWord('hästrasen'); 
highlightWord('emellanåt'); 
highlightWord('bidrar till'); 
highlightWord('splittrad'); 
highlightWord('förmyndare'); 
highlightWord('glesbygdskommuners'); 
highlightWord('förebyggas'); 
highlightWord('mättande'); 
highlightWord('Husmanskost'); 
highlightWord('svält'); 
highlightWord('återinför '); 
highlightWord('utsträckning'); 
highlightWord('oavsett'); 
highlightWord('oerhört'); 
highlightWord('känslosamt'); 
highlightWord('brytkraften'); 
highlightWord('invigd'); 
highlightWord('avgångar'); 
highlightWord('långsiktiga'); 
highlightWord('mörkertal'); 
highlightWord('avvärja'); 
highlightWord('följder'); 
highlightWord('annekterade'); 
highlightWord('rättfärdiga '); 
highlightWord('tydliggjort'); 
highlightWord('farhågor'); 
highlightWord('människoarter '); 
highlightWord('ofredande'); 
highlightWord('redovisat'); 
highlightWord('hederlig'); 
highlightWord('ta in'); 
highlightWord('reningsverk'); 
highlightWord('snurrar'); 
highlightWord('slags'); 
highlightWord('elledningar'); 
highlightWord('förtryck'); 
highlightWord('könsstympning'); 
